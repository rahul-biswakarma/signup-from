...
export default function LandingPage() {
	...
	return (
		<div data-testid="signup-component" className="w-full h-[100vh] overflow-hidden grid max-[800px]:grid-cols-[100%] max-[1200px]:grid-cols-[500px_auto] grid-cols-[700px_auto]">
